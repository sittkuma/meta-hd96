...
do_install_append() {
    ...
    install -d ${D}${libdir}/python3.7/site-packages/cryptoauthlib
    lnr ${D}${libdir}/libcryptoauth.so ${D}${libdir}/python3.7/site-packages/cryptoauthlib/libcryptoauth.so
}
...
FILES_${PN}-dev = "/usr/lib/python3.7/site-packages/cryptoauthlib/libcryptoauth.so"
